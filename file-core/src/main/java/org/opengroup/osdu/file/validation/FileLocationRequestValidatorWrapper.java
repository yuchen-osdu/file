...
public class FileLocationRequestValidatorWrapper
    implements ConstraintValidator<ValidFileLocationRequest, FileLocationRequest> {

  final FileLocationRequestValidator fileLocationRequestValidator;

  @Override
  public boolean isValid(FileLocationRequest request, ConstraintValidatorContext context) {
    return fileLocationRequestValidator.isValid(request, context);
  }
